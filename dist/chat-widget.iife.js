(function () {
  ...
  var h3 = Object.defineProperty,
    ...
    z1 = (l, n, i) =>
      n in l
        ? h3(l, n, { enumerable: !0, configurable: !0, writable: !0, value: i })
        : (l[n] = i),
    D = (l, n) => {
    ...
    _2 = (l, n) => {
      ...
      if (l != null && C1)
        for (var s of C1(l)) n.indexOf(s) < 0 && f2.call(l, s) && (i[s] = l[s]);
      return i;
    },
    ...
    g = (l, n, i) =>
      new Promise((s, d) => {
        var f = (L) => {
          ...
          y = (L) =>
            L.done ? s(L.value) : Promise.resolve(L.value).then(f, M);
    ...
    v3 = class {
      constructor() {
        m(this, "_strategy"),
          (this._strategy =
            typeof requestAnimationFrame == "function" ? new f3() : new _3());
      }
      requestAnimationFrame(l) {
      ...
      return function (i = {}) {
        ...
        var V1 = (e) => {
          ...
          F1 = (e = 0, t = NaN) => {
            var r = $,
              a = e + t;
            for (t = e; r[t] && !(t >= a); ) ++t;
            if (16 < t - e && r.buffer && N2)
              return N2.decode(r.subarray(e, t));
            for (a = ""; e < t; ) {
              var o = r[e++];
              if (o & 128) {
                var h = r[e++] & 63;
                if ((o & 224) == 192)
                  a += String.fromCharCode(((o & 31) << 6) | h);
                else {
                  var c = r[e++] & 63;
                  (o =
                    (o & 240) == 224
        ...
        function j3(e, t, r = {}) {
          ...
          (r1[e] = t),
            delete T1[e],
            l1.hasOwnProperty(e) &&
              ((t = l1[e]), delete l1[e], t.forEach((o) => o()));
        }
        function N(e, t, r = {}) {
          return j3(e, t, r);
        }
        var Y1 = (e) => {
          ...
          D1 = (e, t) => {
            ...
            return (
              (t.count = { value: 1 }),
              p1(Object.create(e, { ta: { value: t, writable: !0 } }))
            );
          },
          p1 = (e) =>
        ...
        function q3(e, t) {
          ...
          if (!t || !t.ta)
            throw new w(`Cannot pass "${a2(t)}" as a ${this.name}`);
          if (!t.ta.va)
            throw new w(
              `Cannot pass deleted object as a pointer of type ${this.name}`
            );
        ...
        function g1(e, t, r, a, o, h, c, u, _, v, p) {
          (this.name = e),
            ...
            o || t.za !== void 0
              ? (this.toWireType = q3)
              : ((this.toWireType = a ? V3 : J3), (this.Ca = null));
        }
        var Y2 = (e, t, r) => {
            if (!d.hasOwnProperty(e))
          ...
          x1 = (e, t) => {
            function r(h) {
              o[h] ||
                r1[h] ||
                (T1[h] ? T1[h].forEach(r) : (a.push(h), (o[h] = !0)));
            }
            var a = [],
              o = {};
        ...
        function e2(e, t, r, a, o) {
          ...
          return m1(e, function (...W) {
            ...
            for (var T = 0; T < v; ++T)
              (p[T] = t[T + 2].toWireType(b, W[T])), C.push(p[T]);
            if (((W = a(...C)), u)) J1(b);
            else
        ...
        var Z2 = (e) => {
          ...
          r2 = (e, t) => {
            var r = r1[e];
            if (r === void 0)
              throw ((e = `${t} has unknown type ${X2(e)}`), new w(e));
            return r;
          },
          a2 = (e) => {
          ...
          n3 = (e) => {
            ...
            throw (
              ...
              q1 ||
                0 < s2 ||
                ((t = d.onExit) == null || t.call(d, e), (I1 = !0)),
              new j2(e))
            );
          },
          u0 = (e) => {
        ...
        for (var a3 = Array(256), $1 = 0; 256 > $1; ++$1)
          a3[$1] = String.fromCharCode($1);
        (B2 = a3),
          (w = d.BindingError =
            class extends Error {
              constructor(e) {
          ...
          Object.assign(O1.prototype, {
            ...
            clone: function () {
              if ((this.ta.va || Y1(this), this.ta.Ia))
        ...
        var f0 = {
            c: (e, t, r, a) =>
              S1(
                `Assertion failed: ${e ? F1(e) : ""}, at: ` +
                  [
                    t ? (t ? F1(t) : "") : "unknown filename",
                    r,
                    a ? (a ? F1(a) : "") : "unknown function",
                  ]
              ),
            m: (e, t, r) => {
              var a = new U3(e);
              ...
              X1(W, function () {
                ...
                e1([e, t, r], a ? [a] : [], (F) => {
                  ...
                  F = m1(p, function (...u2) {
                    ...
                    if (U.Ea === void 0)
                      throw new w(p + " has no accessible constructor");
              ...
              (e = O(e)),
                ...
                e1(
                  ...
                  (u) => (
                    Y2(
                      e,
                      e2(e, [u[0], null].concat(u.slice(1)), null, o, h),
                      t - 1
                    ),
                    []
                  )
            ...
            $: (e, t, r, a, o, h, c, u, _, v, p, C) => {
              (r = O(r)),
                ...
                e1(
                  ...
                  [t],
                  (b) => (
                    (b = b[0]), [new g1(r, b.ua, !1, !1, !0, b, a, h, u, v, C)]
                  )
                );
            },
            A: (e, t) => {
            ...
            Y: (e, t, r) => {
              ...
              return (
                ...
                l0(
                  m1(t, (c, u, _, v) => {
                    for (var p = 0, C = 0; C < e; ++C)
                      (h[C] = a[C].readValueFromPointer(v + p)), (p += a[C].Ba);
                    return (
            ...
            S: (e, t) => {
              ...
              return (
                i3().forEach((a, o) => {
                  var h = t + r;
                  for (o = P[(e + 4 * o) >> 2] = h, h = 0; h < a.length; ++h)
                    s1[o++] = a.charCodeAt(h);
                  (s1[o] = 0), (r += a.length + 1);
                }),
                0
          ...
          J = (e) => (J = A.ja)(e),
          Y = () => (Y = A.ka)();
        (d.dynCall_iijj = (e, t, r, a, o, h) =>
          (d.dynCall_iijj = A.la)(e, t, r, a, o, h)),
          (d.dynCall_vijj = (e, t, r, a, o, h) =>
            (d.dynCall_vijj = A.ma)(e, t, r, a, o, h)),
          (d.dynCall_jiii = (e, t, r, a) =>
            (d.dynCall_jiii = A.na)(e, t, r, a)),
          (d.dynCall_jii = (e, t, r) => (d.dynCall_jii = A.oa)(e, t, r)),
          (d.dynCall_viijii = (e, t, r, a, o, h, c) =>
            (d.dynCall_viijii = A.pa)(e, t, r, a, o, h, c)),
          (d.dynCall_iiiiij = (e, t, r, a, o, h, c) =>
            (d.dynCall_iiiiij = A.qa)(e, t, r, a, o, h, c)),
          (d.dynCall_iiiiijj = (e, t, r, a, o, h, c, u, _) =>
            (d.dynCall_iiiiijj = A.ra)(e, t, r, a, o, h, c, u, _)),
  ...
  m(M1, "_ModulePromise", null),
    m(
      M1,
      "_wasmURL",
      `https://cdn.jsdelivr.net/npm/${p2}@${v2}/dist/dotlottie-player.wasm`
    );
  var m2 = class {
      constructor() {
    ...
    C2 = class I {
      constructor(n) {
        ...
        (this._canvas = n.canvas),
          ...
          (this._renderConfig = z(D({}, n.renderConfig), {
            ...
            freezeOnOffscreen:
              (d =
                (s = n.renderConfig) == null ? void 0 : s.freezeOnOffscreen) !=
              null
                ? d
                : !0,
          })),
          M1.load()
            ...
            .catch((f) => {
              this._eventManager.dispatch({
                type: "loadError",
                error: new Error(`Failed to load wasm module: ${f}`),
              });
            }),
      ...
      load(n) {
        ...
        this._dotLottieCore === null ||
          ...
          this._dotLottieCore.setConfig({
            ...
            useFrameInterpolation:
              (L = n.useFrameInterpolation) != null ? L : !0,
            marker: (E = n.marker) != null ? E : "",
            layout: n.layout
              ? {
                  align: N1(n.layout.align, I._wasmModule),
                  fit: j1(n.layout.fit, I._wasmModule),
                }
      ...
      _render() {
        ...
        if (this._dotLottieCore.render()) {
          ...
          return (
            typeof ImageData > "u"
              ? ((s = this._context.createImageData(
                  this._canvas.width,
                  this._canvas.height
                )),
                s.data.set(i))
      ...
      setSpeed(n) {
        this._dotLottieCore !== null &&
          this._dotLottieCore.setConfig(
            z(D({}, this._dotLottieCore.config()), { speed: n })
          );
      }
      ...
      setLoop(n) {
        this._dotLottieCore !== null &&
          this._dotLottieCore.setConfig(
            z(D({}, this._dotLottieCore.config()), { loopAnimation: n })
          );
      }
      setUseFrameInterpolation(n) {
        this._dotLottieCore !== null &&
          this._dotLottieCore.setConfig(
            z(D({}, this._dotLottieCore.config()), { useFrameInterpolation: n })
          );
      }
      ...
      destroy() {
        ...
        x &&
          this._canvas instanceof HTMLCanvasElement &&
          (B.unobserve(this._canvas), G.unobserve(this._canvas)),
      ...
      resize() {
        if (!(!this._dotLottieCore || !this.isLoaded)) {
          if (x && this._canvas instanceof HTMLCanvasElement) {
            ...
            i !== 0 &&
              s !== 0 &&
              ((this._canvas.width = s * n), (this._canvas.height = i * n));
          }
      ...
      setMarker(n) {
        this._dotLottieCore !== null &&
          this._dotLottieCore.setConfig(
            z(D({}, this._dotLottieCore.config()), { marker: n })
          );
      }
      markers() {
        var n;
      ...
      setLayout(n) {
        this._dotLottieCore === null ||
          ...
          this._dotLottieCore.setConfig(
            z(D({}, this._dotLottieCore.config()), {
              layout: {
                align: N1(n.align, I._wasmModule),
                fit: j1(n.fit, I._wasmModule),
              },
            })
          );
      }
      setViewport(n, i, s, d) {
        return this._dotLottieCore === null
          ? !1
          : this._dotLottieCore.setViewport(n, i, s, d);
      }
      static setWasmUrl(n) {
        M1.setWasmUrl(n);
      }
      ...
      postPointerUpEvent(n, i) {
        var s;
        return (s = this._dotLottieCore) == null
          ? void 0
          : s.postPointerUpEvent(n, i);
      }
      postPointerDownEvent(n, i) {
        var s;
        return (s = this._dotLottieCore) == null
          ? void 0
          : s.postPointerDownEvent(n, i);
      }
      postPointerMoveEvent(n, i) {
        var s;
        return (s = this._dotLottieCore) == null
          ? void 0
          : s.postPointerMoveEvent(n, i);
      }
      postPointerEnterEvent(n, i) {
        var s;
        return (s = this._dotLottieCore) == null
          ? void 0
          : s.postPointerEnterEvent(n, i);
      }
      postPointerExitEvent(n, i) {
        var s;
        return (s = this._dotLottieCore) == null
          ? void 0
          : s.postPointerExitEvent(n, i);
      }
      ...
      animationSize() {
        ...
        let f =
          ...
          M =
            (d =
              (s = this._dotLottieCore) == null
                ? void 0
                : s.animationSize().get(1)) != null
              ? d
              : 0;
      ...
      setStateMachineBooleanContext(n, i) {
        ...
        return (d =
          (s = this._dotLottieCore) == null
            ? void 0
            : s.setStateMachineBooleanContext(n, i)) != null
          ? d
          : !1;
      }
      setStateMachineNumericContext(n, i) {
        ...
        return (d =
          (s = this._dotLottieCore) == null
            ? void 0
            : s.setStateMachineNumericContext(n, i)) != null
          ? d
          : !1;
      }
      setStateMachineStringContext(n, i) {
        ...
        return (d =
          (s = this._dotLottieCore) == null
            ? void 0
            : s.setStateMachineStringContext(n, i)) != null
          ? d
          : !1;
      }
      ...
      static transformThemeToLottieSlots(n, i) {
        var s, d;
        return (d =
          (s = I._wasmModule) == null
            ? void 0
            : s.transformThemeToLottieSlots(n, i)) != null
          ? d
          : "";
      }
    };
  ...
  var C3 = C2,
    ...
    E3 = class {
      ...
      getWorker(l) {
        return (
          this._workers.has(l) || this._workers.set(l, new b3()),
          this._workers.get(l)
        );
      }
        ...
        this._create(
          z(D({}, n), {
            renderConfig: z(D({}, n.renderConfig), {
              ...
              freezeOnOffscreen:
                (d =
                  (s = n.renderConfig) == null
                    ? void 0
                    : s.freezeOnOffscreen) != null
                  ? d
                  : !0,
            }),
          })
    ...
    setRenderConfig(n) {
      return g(this, null, function* () {
        ...
        yield this._sendMessage("setRenderConfig", {
          instanceId: this._id,
          renderConfig: z(
            D(D({}, this._dotLottieInstanceState.renderConfig), f),
            {
              devicePixelRatio: s || t1(),
              freezeOnOffscreen: d ?? !0,
            }
          ...
          new Promise((f, M) => {
            let y = (L) => {
              ...
              E.id === d.id &&
                ...
                E.error
                  ? M(new Error(`Failed to execute method ${n}: ${E.error}`))
                  : f(E.result));
            };
    ...
    return new Promise((n) => {
      const i = [],
        ...
        f = new IntersectionObserver((y) => {
          y.forEach((L) => {
            L.isIntersecting
              ? (i.push(L.target), f.unobserve(L.target))
              : s.push(L.target);
          });
        });
  ...
  const A3 = (l) => {
    ...
    function i(s) {
      ...
      s.tagName.toLowerCase() !== "noscript" &&
        (s.children.length === 0
          ? (((d = s.textContent) == null ? void 0 : d.trim()) ?? "").length >
              0 && n.push(s)
  ...
  const b1 = () => {
    ...
    D3 = async (l) => {
      ...
      console.log("visibleDom", n),
        ...
        h1({
          popup: l,
          type: Z.GET_DOM,
          visibleDom: JSON.stringify(n),
          invisibleDom: JSON.stringify(i),
        });
    },
    O3 = (l, n) => {
      const { data: i } = l;
        ...
        switch (i.type) {
          case Z.HIGHLIGHT:
            window.ChatWidget.highlightText({
              keyword: `${i.value.keyword}`,
              nth: Number(i.value.nth ?? 1),
            });
            break;
          case Z.COPY:
    ...
    x3 = (l, n) => {
      ...
      if (!(i instanceof HTMLElement))
        return h1({ popup: n, type: "MOUSE_CLICK", ...s });
      const d = i.tagName,
        f = i.id ? `#${i.id}` : "",
        M = i.className
          ? `.${i.className
